  ...
  return (
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        class={cn(
          "animate-content-hide bg-popover text-popover-foreground data-[expanded]:animate-content-show z-50 min-w-48 origin-[var(--kb-menu-content-transform-origin)] overflow-hidden rounded-md border p-1 shadow-md",
          local.class
        )}
        {...others}
      />
  ...
  return (
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.SubContent
        class={cn(
          "bg-popover text-popover-foreground animate-in z-50 min-w-32 origin-[var(--kb-menu-content-transform-origin)] overflow-hidden rounded-md border p-1 shadow-md hover:cursor-pointer",
          local.class
        )}
        {...others}
      />
...
const MenubarItem = <T extends ValidComponent = "div">(
  ...
  return (
    <MenubarPrimitive.Item
      class={cn(
        "focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-none select-none hover:cursor-pointer data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        local.inset && "pl-8",
        local.class
      )}
      {...others}
...
const MenubarCheckboxItem = <T extends ValidComponent = "div">(
  ...
  return (
    <MenubarPrimitive.CheckboxItem
      class={cn(
        "focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center rounded-sm py-1.5 pr-2 pl-8 text-sm outline-none select-none hover:cursor-pointer data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        local.class
      )}
      {...others}>
...
const MenubarSeparator = <T extends ValidComponent = "hr">(
  ...
  return (
    <MenubarPrimitive.Separator class={cn("bg-muted -mx-1 my-1 h-px", local.class)} {...others} />
  );
};
