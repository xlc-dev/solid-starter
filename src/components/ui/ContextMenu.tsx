...
const ContextMenuSubTrigger = <T extends ValidComponent = "div">(
  ...
  return (
    <ContextMenuPrimitive.SubTrigger
      class={cn(
        "focus:bg-accent data-[state=open]:bg-accent flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-none select-none hover:cursor-pointer",
        local.class
      )}
      {...others}>
      {local.children}
...
const ContextMenuCheckboxItem = <T extends ValidComponent = "div">(
  ...
  return (
    <ContextMenuPrimitive.CheckboxItem
      class={cn(
        "focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center rounded-sm py-1.5 pr-2 pl-8 text-sm transition-colors outline-none select-none hover:cursor-pointer data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        local.class
      )}
      {...others}>
